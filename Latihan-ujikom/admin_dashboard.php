...
<header>
  ...
  <div class="p-5 text-center bg-light">
    ...
    <h4 class="mb-3">Web ini dibuat untuk keperluan Uji Kompetensi</h4>
    <br>
    <p class="mb-3">Nama : Vyka Septiani</p>
    <p class="mb-3">Nomor Peserta : 181011402401</p>
...
<footer class="text-center text-white fixed-bottom" style="background-color: #21081a;">
  ...
  <div class="text-center p-1" style="background-color: rgba(0, 0, 0, 0.2);"> by :
    <a class="text-white" href="#">Vyka Septiani</a>
  </div>
